...
public class ProblemSpecificationItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DslPackage.Literals.PROBLEM_SPECIFICATION__QOS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ProblemSpecification.class)) {
			...
			case DslPackage.PROBLEM_SPECIFICATION__QOS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DslPackage.Literals.PROBLEM_SPECIFICATION__ROBOTS_MODEL,
				 DslFactory.eINSTANCE.createRobotsModel()));
		...
		newChildDescriptors.add
			(createChildParameter
				(DslPackage.Literals.PROBLEM_SPECIFICATION__MISSION,
				 DslFactory.eINSTANCE.createAtomicTaskNoLoc()));

		newChildDescriptors.add
			(createChildParameter
				(DslPackage.Literals.PROBLEM_SPECIFICATION__MISSION,
				 DslFactory.eINSTANCE.createAtomicTaskLoc()));

		newChildDescriptors.add
			(createChildParameter
				(DslPackage.Literals.PROBLEM_SPECIFICATION__MISSION,
				 DslFactory.eINSTANCE.createCompTaskNoLoc()));

		newChildDescriptors.add
			(createChildParameter
				(DslPackage.Literals.PROBLEM_SPECIFICATION__MISSION,
				 DslFactory.eINSTANCE.createCompTaskOneLoc()));

		newChildDescriptors.add
			(createChildParameter
				(DslPackage.Literals.PROBLEM_SPECIFICATION__MISSION,
				 DslFactory.eINSTANCE.createCompTaskAllLoc()));

		newChildDescriptors.add
			(createChildParameter
				(DslPackage.Literals.PROBLEM_SPECIFICATION__MISSION,
				 DslFactory.eINSTANCE.createCompTaskAtBut()));

		newChildDescriptors.add
			(createChildParameter
				(DslPackage.Literals.PROBLEM_SPECIFICATION__MISSION,
				 DslFactory.eINSTANCE.createCompTaskStatedBut()));

		newChildDescriptors.add
			(createChildParameter
				(DslPackage.Literals.PROBLEM_SPECIFICATION__MISSION,
				 DslFactory.eINSTANCE.createCompTaskListLoc()));

		newChildDescriptors.add
			(createChildParameter
				(DslPackage.Literals.PROBLEM_SPECIFICATION__QOS,
				 DslFactory.eINSTANCE.createQoS()));

		newChildDescriptors.add
			(createChildParameter
				(DslPackage.Literals.PROBLEM_SPECIFICATION__QOS,
				 DslFactory.eINSTANCE.createAllRobotsXX()));

		newChildDescriptors.add
			(createChildParameter
				(DslPackage.Literals.PROBLEM_SPECIFICATION__QOS,
				 DslFactory.eINSTANCE.createAllRobotsX()));

		newChildDescriptors.add
			(createChildParameter
				(DslPackage.Literals.PROBLEM_SPECIFICATION__QOS,
				 DslFactory.eINSTANCE.createRobotsXX()));

		newChildDescriptors.add
			(createChildParameter
				(DslPackage.Literals.PROBLEM_SPECIFICATION__QOS,
				 DslFactory.eINSTANCE.createRobotsX()));

		newChildDescriptors.add
			(createChildParameter
				(DslPackage.Literals.PROBLEM_SPECIFICATION__QOS,
				 DslFactory.eINSTANCE.createAllRobotsDeploy()));

		newChildDescriptors.add
			(createChildParameter
				(DslPackage.Literals.PROBLEM_SPECIFICATION__QOS,
				 DslFactory.eINSTANCE.createNumAllocations()));

		newChildDescriptors.add
			(createChildParameter
				(DslPackage.Literals.PROBLEM_SPECIFICATION__QOS,
				 DslFactory.eINSTANCE.createNumPopulation()));

		newChildDescriptors.add
			(createChildParameter
				(DslPackage.Literals.PROBLEM_SPECIFICATION__QOS,
				 DslFactory.eINSTANCE.createNumEvaluations()));
	}
