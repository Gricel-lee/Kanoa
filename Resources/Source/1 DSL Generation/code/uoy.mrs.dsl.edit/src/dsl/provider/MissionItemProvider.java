...
public class MissionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DslPackage.Literals.MISSION__DESCRIPTION,
				 true,
				 false,
				 false,
	...
	protected void addCriticalityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Mission_criticality_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Mission_criticality_feature", "_UI_Mission_type"),
				 DslPackage.Literals.MISSION__CRITICALITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Mission)object).getDescription();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Mission.class)) {
			case DslPackage.MISSION__DESCRIPTION:
			case DslPackage.MISSION__CRITICALITY:
